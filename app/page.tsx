...
const PRODUCTIVE_LINKS = [
  ...
  {
    label: "System Design",
    url: "https://theshivanshvasu.com/courses/system-design-mastery-series",
    emoji: "📊",
    sub: "lets have some fun designing systems!",
    nameColor: "#f17171",
    borderColor: "#2e0e0e",
    bg: "#100606",
    accentColor: "#ef4444",
  ...
  {
    label: "Discord",
    url: "https://discord.com/channels/1511237107857752074/1512339282797269022",
    emoji: "❤︎",
    sub: "keep a check on ur teammates lol",
    nameColor: "#7ee787",
    borderColor: "#1a2e1a",
    bg: "#080f08",
    accentColor: "#22c55e",
